...
import { Navigation, Pagination, EffectCreative, Autoplay } from 'swiper/modules'; // Add Autoplay for automatic sliding
import 'swiper/css';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-10">
      ...
      >
        ...
        <SwiperSlide>
          <div className="h-64 bg-cover bg-center" style={{ backgroundImage: 'url(https://via.placeholder.com/800x400/3b82f6/ffffff?text=Slide+1)' }}>
        ...
        {/* Slide 2 */}
        <SwiperSlide>
          <div className="h-64 bg-cover bg-center" style={{ backgroundImage: 'url(https://via.placeholder.com/800x400/10b981/ffffff?text=Slide+2)' }}>
        ...
        {/* Slide 3 */}
        <SwiperSlide>
          <div className="h-64 bg-cover bg-center" style={{ backgroundImage: 'url(https://via.placeholder.com/800x400/f97316/ffffff?text=Slide+3)' }}>
        ...
        {/* Slide 4 */}
        <SwiperSlide>
          <div className="h-64 bg-cover bg-center" style={{ backgroundImage: 'url(https://via.placeholder.com/800x400/f472b6/ffffff?text=Slide+4)' }}>
