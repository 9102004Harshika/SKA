...
import { FaTimes, FaSchool, FaBookOpen, FaClock, FaUpload } from "react-icons/fa";
...
const AddNotes = () => {
  ...
  const { handleSubmit, loading: isSubmitting, progress } = useAddNotes();
    ...
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-8 font-body">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <form
            onSubmit={(e) =>
              handleSubmit(e, formData, setFormData, openModal, closeModal, resetForm, setUploadType)
            }
            className="p-8"
          >
            {/* Notes Details Tab */}
