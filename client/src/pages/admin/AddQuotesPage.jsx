...
function QuoteForm(){
    ...
    const handleSubmit=async(e)=>{
        e.preventDefault();
        await axios.post('http://localhost:5000/api/quotes/add',formData)
        toast({
    ...
    return(
       ...
       <div className="max-w-4xl mx-auto p-4">
        ...
        <form onSubmit={(e)=>handleSubmit(e)}  className="space-y-6 flex flex-col">
          <div className="flex">
