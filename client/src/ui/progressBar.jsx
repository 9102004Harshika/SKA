      ...
      >
        <g transform="translate(100,100)">
          <g
            ...
            style={{ transform: `rotate(${(roundedProgress / 100) * 360}deg)` }}
          >
            <circle
              transform="rotate(-90)"
              strokeDashoffset={adjustedStrokeOffset(
                maxStrokeOffset.body1,
                roundedProgress
              )}
